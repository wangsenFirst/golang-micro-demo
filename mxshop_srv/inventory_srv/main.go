...
import (
	...
	"mxshop/inventory_srv/handler"
	"mxshop/inventory_srv/utils/register/consul"
	"net"
	"os"
	"os/signal"
	"syscall"
	...
	"mxshop/inventory_srv/initialize"
	"mxshop/inventory_srv/proto"
	"mxshop/inventory_srv/utils"
)
