...
import (
	"flag"
	"fmt"
	"mxshop/userop_srv/handler"
	"mxshop/userop_srv/utils/register/consul"
	"net"
	"os"
	"os/signal"
	"syscall"
	...
	"mxshop/userop_srv/global"
	"mxshop/userop_srv/initialize"
	"mxshop/userop_srv/proto"
	"mxshop/userop_srv/utils"
)
