...
import (
	...
	"io"
	"log"
	"mxshop/goods_srv/global"
	"mxshop/goods_srv/model"
	"os"
	"strconv"
	"time"
)
...
func main() {
	dsn := "root:123456@tcp(81.70.45.186:3306)/mxshop_goods_srv?charset=utf8mb4&parseTime=True&loc=Local"
...
func Mysql2Es() {
	dsn := "root:123456@tcp(81.70.45.1864:3306)/mxshop_goods_srv?charset=utf8mb4&parseTime=True&loc=Local"
